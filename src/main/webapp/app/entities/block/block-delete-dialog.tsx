...
export const BlockDeleteDialog = (props: IBlockDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.block.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.block.delete.question" interpolate={{ id: blockEntity.id }}>
